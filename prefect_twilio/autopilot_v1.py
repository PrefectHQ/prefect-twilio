...
@task
async def get_v1_assistants_assistant_sid_field_types_field_type_sid_field_values(  # noqa
    assistant_sid: str,
    field_type_sid: str,
    twilio_credentials: "TwilioCredentials",
    language: str = None,
...
@task
async def post_v1_assistants_assistant_sid_field_types_field_type_sid_field_values(  # noqa
    assistant_sid: str,
    field_type_sid: str,
    twilio_credentials: "TwilioCredentials",
    language: str = None,
...
@task
async def delete_v1_assistants_assistant_sid_field_types_field_type_sid_field_values_sid(  # noqa
    assistant_sid: str,
    field_type_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_assistants_assistant_sid_field_types_field_type_sid_field_values_sid(  # noqa
    assistant_sid: str,
    field_type_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def delete_v1_assistants_assistant_sid_tasks_task_sid_fields_sid(  # noqa
    assistant_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_assistants_assistant_sid_tasks_task_sid_fields_sid(  # noqa
    assistant_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def delete_v1_assistants_assistant_sid_tasks_task_sid_samples_sid(  # noqa
    assistant_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_assistants_assistant_sid_tasks_task_sid_samples_sid(  # noqa
    assistant_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def post_v1_assistants_assistant_sid_tasks_task_sid_samples_sid(  # noqa
    assistant_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_assistants_assistant_sid_tasks_task_sid_statistics(  # noqa
    assistant_sid: str,
    task_sid: str,
    twilio_credentials: "TwilioCredentials",
) -> Dict[str, Any]:
