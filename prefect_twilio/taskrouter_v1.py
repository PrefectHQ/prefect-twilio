...
@task
async def get_v1_workspaces_workspace_sid_task_queues_task_queue_sid_cumulative_statistics(  # noqa
    workspace_sid: str,
    task_queue_sid: str,
    twilio_credentials: "TwilioCredentials",
    end_date: str = None,
...
@task
async def get_v1_workspaces_workspace_sid_task_queues_task_queue_sid_real_time_statistics(  # noqa
    workspace_sid: str,
    task_queue_sid: str,
    twilio_credentials: "TwilioCredentials",
    task_channel: str = None,
...
@task
async def get_v1_workspaces_workspace_sid_task_queues_task_queue_sid_statistics(  # noqa
    workspace_sid: str,
    task_queue_sid: str,
    twilio_credentials: "TwilioCredentials",
    end_date: str = None,
...
@task
async def get_v1_workspaces_workspace_sid_tasks_task_sid_reservations(  # noqa
    workspace_sid: str,
    task_sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_workspaces_workspace_sid_tasks_task_sid_reservations_sid(  # noqa
    workspace_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def post_v1_workspaces_workspace_sid_tasks_task_sid_reservations_sid(  # noqa
    workspace_sid: str,
    task_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_workspaces_workspace_sid_workers_cumulative_statistics(  # noqa
    workspace_sid: str,
    twilio_credentials: "TwilioCredentials",
    end_date: str = None,
    minutes: int = None,
...
@task
async def get_v1_workspaces_workspace_sid_workers_real_time_statistics(  # noqa
    workspace_sid: str,
    twilio_credentials: "TwilioCredentials",
    task_channel: str = None,
) -> Dict[str, Any]:
...
@task
async def get_v1_workspaces_workspace_sid_workers_worker_sid_channels(  # noqa
    workspace_sid: str,
    worker_sid: str,
    twilio_credentials: "TwilioCredentials",
    page_size: int = None,
...
@task
async def get_v1_workspaces_workspace_sid_workers_worker_sid_channels_sid(  # noqa
    workspace_sid: str,
    worker_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def post_v1_workspaces_workspace_sid_workers_worker_sid_channels_sid(  # noqa
    workspace_sid: str,
    worker_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_workspaces_workspace_sid_workers_worker_sid_reservations(  # noqa
    workspace_sid: str,
    worker_sid: str,
    twilio_credentials: "TwilioCredentials",
    reservation_status: str = None,
...
@task
async def get_v1_workspaces_workspace_sid_workers_worker_sid_reservations_sid(  # noqa
    workspace_sid: str,
    worker_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def post_v1_workspaces_workspace_sid_workers_worker_sid_reservations_sid(  # noqa
    workspace_sid: str,
    worker_sid: str,
    sid: str,
    twilio_credentials: "TwilioCredentials",
...
@task
async def get_v1_workspaces_workspace_sid_workers_worker_sid_statistics(  # noqa
    workspace_sid: str,
    worker_sid: str,
    twilio_credentials: "TwilioCredentials",
    minutes: int = None,
...
@task
async def get_v1_workspaces_workspace_sid_workflows_workflow_sid_cumulative_statistics(  # noqa
    workspace_sid: str,
    workflow_sid: str,
    twilio_credentials: "TwilioCredentials",
    end_date: str = None,
...
@task
async def get_v1_workspaces_workspace_sid_workflows_workflow_sid_real_time_statistics(  # noqa
    workspace_sid: str,
    workflow_sid: str,
    twilio_credentials: "TwilioCredentials",
    task_channel: str = None,
...
@task
async def get_v1_workspaces_workspace_sid_workflows_workflow_sid_statistics(  # noqa
    workspace_sid: str,
    workflow_sid: str,
    twilio_credentials: "TwilioCredentials",
    minutes: int = None,
